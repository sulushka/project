        ...
        <div class="block-content">
            <table class="table table-bordered">
                ...
                @foreach ($tasks as $item)
                    ...
                    <td><a href='{{asset("storage/".$item->resources)}}' target="_blank"><i class='fa fa-cloud-download fa-2x'></i></a></td>
                        <td>
                            <div class="btn-group">
                                <a class="btn btn-xs btn-default" href="{{route('tasks.edit', $item->id)}}" data-toggle="tooltip" title="" data-original-title="Edit Client"><i class="fa fa-pencil"></i></a>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal push-10-t" action="{{route('tasks.store')}}" method="post"  enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <div class="col-xs-12">
                    <input type="file" id="example-file-multiple-input" name="image" >
                </div>
            </div>
